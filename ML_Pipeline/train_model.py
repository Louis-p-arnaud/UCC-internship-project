...
# 3. Train the model
# You can change the clf by any classifier. Ex:
    # RandomForestClassifier
    # KNeighborsClassifier
    # MLPClassifier

print("Training the model...")
clf = RandomForestClassifier(n_estimators=100, random_state=42) # n_estimators = nombre d'arbres dans la forêt
clf.fit(X_train, y_train)

# 4. Sauvegarder
joblib.dump(clf, 'saved_models/fatigue_RandomForest.joblib')
